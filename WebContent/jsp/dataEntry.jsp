...
                        <td><input type="text" name="patientname" id="patientname" value=""  onClick="clearSpan('divpatientname')"  /><span id="divpatientname"></span></td>
                    </tr>
					-->
					<tr>
                        <td class="index">Patient NHI</td>
                        <td><input type="text" name="patientnhi" id="patientnhi" value=""  onClick="clearSpan('divpatientnhi')"  /><span id="divpatientnhi"></span></td>
                    </tr>
					<tr>
...
                        <td><input type="date" name="date" id="datepicker"  /><span id="divdate"></span> </td>
					...
					<tr>
    					...
    					<tr>
    						...
    						<td>
    						<input type="number" name="numOfBMS" id="numOfBMS" value="" onClick="clearSpan('divBMS')" /><span id="divBMS"></span>
    						</td>
    				   </tr>
    				   ...
    				   <tr>
    						...
    						<td>
    						<input type="number" name="numOfDES" id="numOfDES" value="" onClick="clearSpan('divDES')" /><span id="divDES"></span>
    						</td>
    				   </tr>
    				     ...
    				     <tr>
    						...
    						<td>
    						<input type="number" name="numOfDEB" id="numOfDEB" value="" onClick="clearSpan('divDEB')" /><span id="divDEB"></span>
    						</td>
    				    </tr>
    				     ...
    				     <tr>
    						...
    						<td>
    						<input type="number" name="numOfLMS" id="numOfLMS" value="" onClick="clearSpan('divLMS')" /><span id="divLMS"></span>
    						</td>
    				    </tr>
    				    ...
    				    <tr>
    						...
    						<td>
    						<input type="number" name="numOfLAD" id="numOfLAD" value="" onClick="clearSpan('divLAD')" /><span id="divLAD"></span>
    						</td>
    				    </tr>
    				     ...
    				     <tr>
    						...
    						<td>
    						<input type="number" name="numOfCx" id="numOfCx" value="" onClick="clearSpan('divCx')" /><span id="divCx"></span>
    						</td>
    				    </tr>
    				     ...
    				     <tr>
    						...
    						<td>
    						<input type="number" name="numOfRCA" id="numOfRCA" value="" onClick="clearSpan('divRCA')" /><span id="divRCA"></span>
    						</td>
    				    </tr>
    				    ...
    				    <tr>
    						...
    						<td>
    						<input type="number" name="ramus" id="ramus" value="" onClick="clearSpan('divRamus')" /><span id="divRamus"></span>
    						</td>
    				    </tr>
    				    ...
    				    <tr>
    						...
    						<td>
    						<input type="number" name="graft" id="graft" value="" onClick="clearSpan('divGraft')" /><span id="divGraft"></span>
    						</td>
    				    </tr>
    				     ...
    				     <tr>
    						...
    						<td>
    						<input type="number" name="branchVessel" id="branchVessel" value="" onClick="clearSpan('divBranchVessel')" /><span id="divBranchVessel"></span>
    						</td>
    				    </tr>
    				    ...
    				    <tr>
    						...
    						<td>
    						<input type="number" name="additionalProcedures" id="additionalProcedures" value="" onClick="clearSpan('divAdditionalProcedures')" /><span id="divAdditionalProcedures"></span>
    						</td>
    				    </tr>
    				     ...
    				     <tr>
    						...
    						<td>
    						<input type="number" name="lvgram" id="lvgram" value="" onClick="clearSpan('divLvgram')" /><span id="divLvgram"></span>
    						</td>
    				    </tr>
    				     ...
    				     <tr>
    						...
    						<td>
    						<input type="number" name="aortogram" id="aortogram" value="" onClick="clearSpan('divAortogram')" /><span id="divAortogram"></span>
    						</td>
    				    </tr>
    				     ...
    				     <tr>
    						...
    						<td>
    						<input type="number" name="bypassangio" id="bypassangio" value="" onClick="clearSpan('divBypassAngio')" /><span id="divBypassAngio"></span>
    						</td>
    				    </tr>
    				     ...
    				     <tr>
    						...
    						<td>
    						<input type="number" name="rhc" id="rhc" value="" onClick="clearSpan('divRhc')" /><span id="divRhc"></span>
    						</td>
    				    </tr>
    				     ...
    				     <tr>
    						...
    						<td>
    						<input type="number" name="hocm" id="hocm" value="" onClick="clearSpan('divHOCM')" /><span id="divHOCM"></span>
    						</td>
    				    </tr>
    				    ...
    				    <tr>
    						...
    						<td>
    						<input type="number" name="ivus" id="ivus" value="" onClick="clearSpan('divIvus')" /><span id="divIvus"></span>
    						</td>
    				    </tr>
    				     ...
    				     <tr>
    						...
    						<td>
    						<input type="number" name="oct" id="oct" value="" onClick="clearSpan('divOCT')" /><span id="divOCT"></span>
    						</td>
    				    </tr>
    				     ...
    				     <tr>
    						...
    						<td>
    						<input type="number" name="ffr" id="ffr" value="" onClick="clearSpan('divFFR')" /><span id="divFFR"></span>
    						</td>
    				    </tr>
    				     <tr>
    						<td class="index">Angioseal</td>
    						<td>
    						<input type="number" name="angioseal" id="angioseal" value="" onClick="clearSpan('divAngioseal')" /><span id="divAngioseal"></span>
    						</td>
    				    </tr>
    				     ...
    				     <tr>
    						...
    						<td>
    						<input type="number" name="proglide" id="proglide" value="" onClick="clearSpan('divProglide')" /><span id="divProglide"></span>
    						</td>
    				    </tr>
						...
						<tr>
    						...
    						<td>
    						<input type="number" name="balloon" id="balloon" value="" onClick="clearSpan('divBalloon')" /><span id="divBalloon"></span>
    						</td>
    				    </tr>
    				    ...
    				    <tr>
    						...
    						<td>
    						<input type="number" name="angiosculpt" id="angiosculpt" value="" onClick="clearSpan('divAngiosculpt')" /><span id="divAngiosculpt"></span>
    						</td>
    				    </tr>
						 <tr>
    						<td class="index">Rotablation</td>
    						<td>
    						<input type="number" name="rotablation" id="rotablation" value="" onClick="clearSpan('divRotablation')" /><span id="divRotablation"></span>
    						</td>
    				    </tr>
    				     ...
    				     <tr>
    						...
    						<td>
    						<input type="number" name="pami" id="pami" value="" onClick="clearSpan('divPami')" /><span id="divPami"></span>
    						</td>
    				    </tr>
    				     ...
    				     <tr>
    						...
    						<td>
    						<input type="number" name="complexcto" id="complexcto" value="" onClick="clearSpan('divComplexCto')" /><span id="divComplexCto"></span>
    						</td>
    				    </tr>
    				    ...
    				    <tr>
    						...
    						<td>
    						<input type="number" name="complexbifucation" id="complexbifucation" value="" onClick="clearSpan('divComplexBifucation')" /><span id="divComplexBifucation"></span>
    						</td>
    				    </tr>
						 <tr>
    						<td class="index">Complications</td>
    						<td>
    						<input type="number" name="complications" id="complications" value="" onClick="clearSpan('divComplications')" /><span id="divComplications"></span>
    						</td>
    				    </tr>
    				     ...
    				     <tr>
    						...
    						<td>
    						<input type="text" name="complicationdesc" id="complicationdesc" value="" onClick="clearSpan('divComplicationDesc')" /><span id="divComplicationDesc"></span>
    						</td>
    				    </tr>
    				    ...
    				    <tr>
    						...
    						<td>
    						<input type="text" name="comment" id="comment" value="" onClick="clearSpan('divComment')" /><span id="divComment"></span>
    						</td>
    				    </tr>
			...
			<tr>
                        <td class="index"><input type="Submit" value="Save Patient Details" class="admin"/>&nbsp<span id="savepatient"></span></td>
                       <!--   <td class="index"><input type="button" value="Delete Patient" class="button2" onClick="deletePatient()"/>--><!--  &nbsp&nbsp <input type="button" value="Edit Patient" class="button2" onClick="editPatient()"/> --> </td>
            </tr>
...
function deletePatient()
{
	...
	if (result) 
	{
	    ...
	    try
	    {
			var posturl = "patientnhi=" + patientnhi   ;
...
function GetSelectedConsultantId(fname, lname)
{
	...
	{ 
		...
		*/
		//Make patient name empty string for privacy reasons
		var patientname = "";
				...
				xmlhttpobj.onreadystatechange = function()
			    {
			        if(xmlhttpobj.readyState == 4 && xmlhttpobj.status == 200)
			        {
			        	...
			        	if(trimmedResponse.toLowerCase()==saved.toLowerCase())
		            	{
		            		...
		            		document.getElementById("savepatient").style.color = "red";
		            		document.getElementById("savepatient").innerHTML = "Saved Patient Record!";
		            		resetValues();
